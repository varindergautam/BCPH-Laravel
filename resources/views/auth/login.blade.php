                ...
                <div class="col-12 col-sm-6 col-md-6">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img class="h-100 w-100" src="{{ url('/admin/login/img/slide-img.jpg') }}" alt="First slide" style="height: 500px !important;">
                      </div>
                      <div class="carousel-item">
                        <img class="h-100 w-100" src="{{ url('/admin/login/img/slide-img.jpg') }}" alt="Second slide" style="height: 500px !important;">
                      </div>
                      <div class="carousel-item">
                        <img class="h-100 w-100" src="{{ url('/admin/login/img/slide-img.jpg') }}" alt="Third slide" style="height: 500px !important;">
                      </div>
                    </div>
                  </div>
                </div>
