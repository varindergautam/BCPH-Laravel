        ...
        <div class="row ">
            <div class="col-md-12">
                <div class="form_section border p-3 rounded-1">
                    <form method="get" action="{{ route('enrolmentAsAdvocate') }}" enctype="mutlipart/form-data" id="step1-form">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <p class="text-dark"><strong>{{ auth::user()->father_name }}</strong></p>
                        ...
                        <div class="row">
                             <div class="col ">
                                <div class=" margin_top_33">
                                    <a href="{{ route('certifyForm') }}" name="" class="custom_btn previous_btn_padding">Previous</a>
                                </div>
                            </div>
                            <div class="col ">
