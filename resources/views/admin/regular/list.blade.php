    ...
    <script>
        jQuery(document).ready(function() {
            ...
            jQuery('#size_table').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": "{{ route('admin.regular.regularAjax') }}",
                },
                "columns": [{
                        "data": "sr_no"
                    },
                    ...
                    { "orderable": false, "data": "cop_certificate",
                        render: function ( data ) {
                            return '<img src='+data+' width="100px">' ;
                        }
                    },
                    { "orderable": false, "data": "upload_enrolment",
                        render: function ( data ) {
                            return '<img src='+data+' width="100px">' ;
                        }
                    },
                    { "orderable": false, "data": "law_degree",
                        render: function ( data ) {
                            return '<img src='+data+' width="100px">' ;
                        }
                    },
