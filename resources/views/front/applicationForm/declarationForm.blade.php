                ...
                <div class="col-md-12">
                    <div class="form_section border p-3 rounded-1">
                        <form method="post" action="" enctype="mutlipart/form-data" id="declaration-form">
                            ...
                            <div class="paragraph">
                                <p class="text-dark">I <strong>{{ auth::user()->applicant_name }}</strong> declare that the
                                    facts stated below are true to my knowledge.</p>
                            </div>
                            <div class="listing text-dark">
                                ...
                                <ul style="list-style-type: circle;">
                                    ...
                                    <li>I am a citizen of India or a National of a country
                                        <strong>{{ auth::user()->nationality }}</strong> where citizens of India, duly
