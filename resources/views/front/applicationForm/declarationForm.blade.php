            ...
            <div class="form_heading">
              ...
              <div class="listing text-dark">
                  ...
                  <ul style="list-style-type: circle;">
                      ...
                      <li>I have obtained Law degree from <input type="text remove_border_input" name="law_university_name" placeholder="Enter university" value=""><strong id="law_university_name-error" class="error"></strong> University which has been recognised by the Bar Council of India u/s 24 (i)(c) (iii) of the Advocates Act 1961 and the Law College <input type="text" name="law_college_name" placeholder="Enter college name" value=""><strong id="law_college_name-error" class="error"></strong> where I studied for three/five years is also recognised by the Bar Council of India for imparting Legal Education and is affiliated with <input type="text" placeholder="Enter affiliated university" value="" name="law_affiliated_university"><strong id="law_affiliated_university-error" class="error"></strong> University.</li>
