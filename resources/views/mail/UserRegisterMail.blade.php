...
<div style="max-width:600px;margin:0 auto;background:#fff;">
    ...
    <div style="width:100%;box-shadow:0px 0px 9px #b7b0b0;text-align:center;">
        ...
        <div style="width:100%; text-align:center;padding:10px 20px;">
            ...
            <p style="font-size:22px;font-style:oblique;color:#847f7f;font-weight: 300;margin-bottom:40px;">Welcome to
                the BCPH .From now on, please log in to your account using following Detail</p>
        ...
        <div style="float:left;width:100%; padding:3px 10px;background:#b1c252;text-align:center;">
            <p style="font-size:13px;"><span style="color:#fdfdfd;font-weight:300;">Powered By: </span><span style="font-weight:500;color:#fff;">BCPH</span></p>
        </div>
    </div>
</div>
</body>
